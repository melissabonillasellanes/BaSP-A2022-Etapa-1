...
// Crear un array que contenga 5 palabras y recorrer dicho array utilizando un bucle for
// de JavaScript para mostrar una alerta utilizando cada una de las palabras.

console.log("-Exercise 5.a:");

var colores = ["rojo", "azul", "blanco", "rosado", "negro"];
...
for(i=0; i<colores.length; i++) {
    alert(colores[i].substring(1, 0).toUpperCase() +
    colores[i].substring(1, colores[i].length));
}
